<div align="center">
  <img src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=2070&auto=format&fit=crop" alt="Банер soBooking" width="100%" style="border-radius: 12px; margin-bottom: 2rem;">
  
  <h1> soBooking Apartments</h1>
...
👉 **[Перейти на сайт soBooking (Railway Production)](https://sofia-odeskaya-apartments-production.up.railway.app/)**
...
1. **Клонуйте репозиторій**
   ```bash
   git clone https://github.com/yourusername/sobooking.git
   cd sobooking
   ```
